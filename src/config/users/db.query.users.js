const dbQueryUsers = () => {
    ...
    const SELECT_USERS = 'SELECT * FROM users WHERE username = $1';
    return {
        INSERT_USERS, SELECT_USERS_LIST, SELECT_USERS_ID, SELECT_USERS_SEARCH, DELETE_USERS, UPDATE_USERS, SELECT_USERS
    }
}
